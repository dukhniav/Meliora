"""
Various tool function for Meliora and scripts
"""
import gzip
import logging
import re
...
from meliora.config.constants import DECIMAL_PER_COIN_FALLBACK, DECIMALS_PER_COIN
...
#             rapidjson.dump(data, fpz, default=str, number_mode=json.NM_NATIVE)
#     else:
#         if log:
#             logger.info(f'dumping json to "{filename}"')
